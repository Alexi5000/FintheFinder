...
export function buildContractArtifacts() {
  const contracts = {
    ...
    schemas: {
      ...
      evalHistoryResponse: z.toJSONSchema(evalHistoryResponseSchema),
      evalResult: z.toJSONSchema(evalResultSchema),
      evalResultSummary: z.toJSONSchema(evalResultSummarySchema),
      evalRun: z.toJSONSchema(evalRunSchema),
      evalRunWithResults: z.toJSONSchema(evalRunWithResultsSchema),
      evalScores: z.toJSONSchema(evalScoresSchema),
      evalSuiteSummary: z.toJSONSchema(evalSuiteSummarySchema),
